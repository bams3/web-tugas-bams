            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3><center>LIHAT DATA VENDOR</center></h3>
                    </div>

                    <div class="card-body">
                        <div class="form-group row mb-2">
                            <label class="col-3">Nama Vendor</label>
                            <div class="col-3">
                                <input type="text" class="fore-control" value="<?=$data['vdr']['nama'];?>">
                            </div>
                        </div>
                        <br>
                        <div class="form-group row mb-2">
                            <label class="col-3">Nomor Vendor</label>
                            <div class="col-3">
                                <input type="text" class="fore-control" value="<?=$data['vdr']['no_telepon'];?>">
                            </div>
                        </div>
                        <br>
                        <div class="form-group row mb-2">
                            <label class="col-3">Alamat Vendor</label>
                            <div class="col-3">
                                <input type="text" class="fore-control" value="<?=$data['vdr']['alamat_vendor'];?>">
                            </div>
                        </div>
                        <br>
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-3">
                                <input type="text" class="fore-control" value="<?=$data['vdr']['jumlah_pesan_vendor'];?>">
                            </div>
                        </div>
                        <br>
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-3">
                                <input type="text" class="fore-control" value="<?=$data['vdr']['total_nilai_pesan'];?>">
                            </div>
                        </div>
                        <br>
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-3">
                                <input type="text" class="fore-control" value="<?=$data['vdr']['jumlah_terima_vendor'];?>">
                            </div>
                        </div>
                        <br>
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-3">
                                <input type="text" class="fore-control" value="<?=$data['vdr']['total_nilai_terima'];?>">
                            </div>
                        </div>
                        <br>
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-3">
                                <input type="text" class="fore-control" value="<?=$data['vdr']['jumlah_bayar_vendor'];?>">
                            </div>
                        </div>
                        <br>
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-3">
                                <input type="text" class="fore-control" value="<?=$data['vdr']['total_nilai_bayar'];?>">
                            </div>
                        </div>
                        <br>
                        <table class="table">
                    ...
                    <div class="card-footer">
                        <a class="btn btn-info btn-sm" href="<?= APLIKASI; ?>/refrensi_vendor/index">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <marquee> <h4>INI ADALAH LIHAT DATA VENDOR</h4> </marquee>
</body>
